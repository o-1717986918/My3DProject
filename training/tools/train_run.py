...
STAGES: dict[str, dict[str, Any]] = {
    ...
    # Stage A: learn a reliable in-place yaw primitive before coupling it to
    # translation. This matches the runtime's turn-first decomposition and
    # ensures the phase-aware actor actually sees pure-yaw command segments.
    "rapid_turn": {
        "lin_vel_x": [0.0, 0.0],
        "lin_vel_y": [0.0, 0.0],
        "ang_vel_yaw": [-1.0, 1.0],
        ...
        "stand_probability": 0.15,
        "command_resample_steps": 60,
        "reset_joint_noise": 0.025,
        "reset_root_velocity_noise": 0.04,
        "reset_yaw_range": 0.20,
        "push_enable": True,
        "push_interval_steps": 175,
        "push_magnitude": [0.02, 0.10],
        "action_delay_max_steps": 1,
        "reward.tracking_linear": 3.0,
        "reward.tracking_yaw": 8.0,
        "reward.upright": 2.0,
        "reward.height": 2.0,
        "reward.alive": 0.75,
        "reward.lateral_tracking": -5.0,
        "reward.yaw_rate_error": -5.0,
        "reward.vertical_velocity": -0.40,
        "reward.angular_xy": -0.35,
    ...
    # Stage B: retain the accepted walking actor while improving braking,
    # lateral drift, command switches, disturbances, and planted-foot slip in
    # the forward domain used by the runtime fallback.
    "stable_forward": {
        "lin_vel_x": [0.15, 1.55],
        "lin_vel_y": [0.0, 0.0],
        "ang_vel_yaw": [0.0, 0.0],
        ...
        "stand_probability": 0.20,
        "command_resample_steps": 90,
        "reset_joint_noise": 0.03,
        "reset_root_velocity_noise": 0.05,
        "reset_yaw_range": 0.12,
        "push_enable": True,
        "push_interval_steps": 150,
        "push_magnitude": [0.02, 0.12],
        "action_delay_max_steps": 1,
    ...
    # Train one reliable lateral direction and obtain the opposite direction
    # through the already verified observation/action reflection. Keeping
    # forward and yaw at zero prevents a nominally omnidirectional curriculum
    # from hiding the missing pure-strafe primitive inside curved travel.
    "lateral_left_expert": {
        "lin_vel_x": [0.0, 0.0],
        "lin_vel_y": [0.18, 0.48],
        "ang_vel_yaw": [0.0, 0.0],
    ...
    "soccer_lateral": {
        ...
        "gait_frequency": [1.0, 2.0],
        "stand_probability": 0.20,
        "axis_aligned_command_probability": 0.65,
        "command_resample_steps": 75,
        "reset_joint_noise": 0.035,
        "reset_root_velocity_noise": 0.06,
        "reset_yaw_range": 0.18,
        "push_enable": True,
        "push_interval_steps": 150,
        "push_magnitude": [0.03, 0.14],
        "action_delay_max_steps": 1,
        "reward.tracking_linear": 7.0,
        "reward.tracking_yaw": 6.0,
        "reward.upright": 2.0,
