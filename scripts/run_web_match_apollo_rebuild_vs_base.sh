...
export APOLLO_ENABLE_PARAMETERIZED_KICK="${APOLLO_ENABLE_PARAMETERIZED_KICK:-1}"
export APOLLO_LEARNED_KICK_MODE="${APOLLO_LEARNED_KICK_MODE:-active}"
export APOLLO_ENABLE_FAST_WALK="${APOLLO_ENABLE_FAST_WALK:-1}"
export APOLLO_ENABLE_RAPID_TURN="${APOLLO_ENABLE_RAPID_TURN:-1}"
