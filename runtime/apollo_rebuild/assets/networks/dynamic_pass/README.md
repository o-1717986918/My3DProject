...
`0.8 m/s`. It is disabled by default and is not evidence of general passing,
...
The selector therefore remains an explicit A/B and training candidate, not a
default team capability. See `docs/rl-experiment-log.md` for the measurements.
